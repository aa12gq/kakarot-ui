...
import {strokeColor} from "@/components/LoadingIndicator/fill-color";
</script>
<template>
    <svg width="39" height="39" viewBox="0 0 45 45" xmlns="http://www.w3.org/2000/svg" :stroke="strokeColor">
