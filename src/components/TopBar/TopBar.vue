  ...
  <div class="top-bar-boxed h-[70px] z-[51] relative border-b border-white/[0.08] mt-12 md:-mt-5 -mx-3 sm:-mx-8 px-3 sm:px-8 md:pt-0 mb-12">
    <div class="flex items-center h-full">
      ...
      <RouterLink :to="{ name: 'gvp-home' }" class="hidden -intro-x md:flex">
        <!-- <img alt="贝吉塔管理平台" class="w-6"  /> -->
        <dl>
          <dt>
            <span class="ml-3 text-sm text-white">贝吉塔管理平台</span>
          </dt>
          <dd class="ml-3 text-xs text-warning pr-1">
            <!-- <img alt="贝吉塔" class="w-12 float-right" :src="logo2Url" /> -->
          </dd>
        </dl>
      </RouterLink>
      <!-- END: Logo -->
      ...
      <Breadcrumb light class="h-full md:ml-10 md:pl-10 md:border-l border-white/[0.08] mr-auto -intro-x">
        ...
        <Breadcrumb.Link to="/" :active="true">物资统计</Breadcrumb.Link>
      </Breadcrumb>
      <!-- END: Breadcrumb -->
      <!-- BEGIN: Search -->
