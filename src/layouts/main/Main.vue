...
<template>
    ...
    <Dialog.Panel>
      <div class="p-5 text-center">
        ...
        <div class="mt-2 text-slate-500">
          请登录后使用本系统。若您已在其他窗口登录，请尝试点击下面的
          <span class="font-bold">"刷新登录状态"</span>
          可继续使用.
          <br />
      ...
      <div class="px-5 pb-8 flex items-center justify-center gap-x-3">
        ...
        <Button type="button" variant="pending" @click="reloadAuth">刷新登录状态</Button>
      </div>
    </Dialog.Panel>
  </Dialog>
  <!-- END: 要求登录提示-->
  ...
  <div id="layoutWrapper" class="relative pb-3 before:content-[''] before:absolute before:inset-0 before:bg-fixed before:bg-no-repeat before:bg-skew-pattern dark:before:bg-skew-pattern-dark">
    <!-- BEGIN: 退出登录提示-->
    <Dialog :open="logoutModalOpen">
      <Dialog.Panel>
        <div class="p-5 text-center">
          ...
          <div class="mt-5 text-3xl pl-3">成功退出登录</div>
          <div class="mt-2 text-slate-500">
            为了保障您的账户安全，已完成退出操作。。
            <br />
            页面将在几秒后跳转至登录界面...
